...
document.querySelector(#dog-picture).addEventListener("click", () => alert ("Dog Picture was clicked"));
...
document.querySelector("#class-schedule-List").addEventListener("mouseover" , (event) => event.target.style.background-Color=  "red"));
